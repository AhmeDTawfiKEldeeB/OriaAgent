...
class OriaState(MessagesState):
    """State class for the Oria workflow.
    ...
    Attributes:
        ...
        workflow (str): The current workflow the Oria is in. Can be "conversation", "image", or "audio".
        audio_buffer (bytes): The audio buffer to be used for speech-to-text conversion.
        current_activity (str): The current activity of Oria based on the schedule.
